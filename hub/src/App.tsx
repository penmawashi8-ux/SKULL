...
const games: Game[] = [
  ...
  },
  {
    ...
    nameEn: 'DAIFUGO',
    symbol: 'DF',
    description: '手札をいちばん早く出し切れ！革命・8切り・11バック・スペ3返しなど定番ローカルルールを12種から自由に選べる。オリジナルの「スチールセブン」も。最大4人のオンライン対戦対応。',
    status: 'available',
    url: '/play/daifugo/',
    accentColor: '#fb7185',
...
const NOTICES = [
  {
    ...
    body: '大富豪に革命・8切り・11バック・9リバース・スペ3返し・階段・しばりなど12種の定番ローカルルールを選択制で追加。7並べもA-K連結・ジョーカー（取り返しあり）に対応し、オリジナルルールを「ブレイクスルー」に刷新しました。',
  },
  {
    id: 11,
    date: '2026.07.17',
