...
const FAQ_ITEMS = [
  ...
  {
    q: '1人でも遊べるゲームはありますか？',
    a: 'あります。「ポコっとライト」は完全1人用のパズルゲームです。「大富豪」「神経衰弱」「リバーシ」「五目並べ」「まるばつ」「すごろく」はCPU対戦で1人でも遊べるほか、「ぶたのしっぽ」「ページワン」「バーチャル競馬」も1人プレイに対応しています。',
  },
  {
    q: 'スマホでも遊べますか？',
  ...
  return (
    <section className="px-5 pb-10 max-w-xl mx-auto">
      ...
      <div className="font-sans-jp text-[12px] leading-relaxed space-y-3" style={{ color: 'rgba(255,255,255,0.6)' }}>
        ...
        <p>
          収録しているのはすべて当サイトが独自に開発したオリジナルゲームです。ブラフと心理戦が熱い「BOMB」や「謀略」、定番トランプゲームの「大富豪」「ぶたのしっぽ」「ページワン」「神経衰弱」、定番ボードゲームの「リバーシ」「五目並べ」「まるばつ」、最大4人でオンライン対戦できる「すごろく」、レース予想を楽しむ「バーチャル競馬」、1人でじっくり遊べるパズル「ポコっとライト」など、大人数のパーティ用から1人用まで幅広くそろえています。大富豪の「スチールセブン」、神経衰弱の「泥棒セブン」、リバーシの「おかわりマス」、すごろくの「ドッスン」など、オリジナルのローカルルールも搭載しています。
        </p>
        <p>
