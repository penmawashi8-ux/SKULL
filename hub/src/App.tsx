...
const games: Game[] = [
  ...
  },
  {
    ...
    nameEn: 'DAIFUGO',
    symbol: 'DF',
    description: '手札をいちばん早く出し切れ！革命・8切りありの定番トランプゲーム。最大4人のオンライン対戦対応、ローカルルール「スチールセブン」搭載。',
    status: 'available',
    url: '/play/daifugo/',
    accentColor: '#fb7185',
  ...
  },
  {
    ...
    nameEn: 'SEVENS',
    symbol: 'SV',
    description: '7から順にカードをつなげて置いていく定番トランプ。パスは3回まで。ローカルルール「おかわりエイト」で8を置けば連続出し！オンライン対戦対応。',
    status: 'available',
    url: '/play/sevens/',
    accentColor: '#38bdf8',
