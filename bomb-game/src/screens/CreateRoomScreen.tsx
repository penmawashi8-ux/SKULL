        ...
        {!roomCode ? (
          ...
          <div className="flex flex-col gap-6">
            ...
            <button
              ...
              className="w-full py-4 rounded-2xl text-white text-xl font-bold disabled:opacity-40 mt-4 active:scale-[0.97] transition-transform"
              style={{
          ...
          <div className="flex flex-col items-center gap-6 pt-8">
            ...
            <button
              onClick={handleCopy}
              className="w-full py-3 rounded-xl border border-white/20 text-white/70 text-sm flex items-center justify-center gap-2 active:scale-[0.97] transition-transform"
              style={{ fontFamily: 'Crimson Text, serif' }}
            >
            ...
            <button
              ...
              className="w-full py-4 rounded-2xl text-white text-xl font-bold active:scale-[0.97] transition-transform"
              style={{
                fontFamily: 'Cinzel, serif',
                background: 'linear-gradient(135deg, #6d28d9, #4c1d95)',
                boxShadow: '0 0 24px rgba(109,40,217,0.4)',
